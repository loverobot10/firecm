...
## Heroku salesforce error solution.
   ...
   - Now use this url to deploy: `Heroku.com/deploy?template=your forked url here` e.g.  `heroku.com/deploy?template=https://github.com/loverobot10/Fire-X`; Here we put YourGitName = maihindu.   
