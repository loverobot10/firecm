...
## Heroku salesforce error solution.
   ...
   - Your Forked Url is looking Like: `https://github.com/loverobot10/Fire-X` ; YourGitName = Your Github Username.
   - Now use this url to deploy: `Heroku.com/deploy?template=template=https://github.com/loverobot10/Fire-X` e.g.  `heroku.com/deploy?template=https://github.com/loverobot10/Fire-X`; Here we put YourGitName = maihindu.   
